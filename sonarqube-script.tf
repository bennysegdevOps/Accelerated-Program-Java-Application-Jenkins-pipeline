...
#Install New relic
curl -Ls https://download.newrelic.com/install/newrelic-cli/scripts/install.sh | bash && sudo  NEW_RELIC_API_KEY=NRAK-YU5MZNUYT2RHO4ERCJOGUZF25TD NEW_RELIC_ACCOUNT_ID=3929947 /usr/local/bin/newrelic install -y
